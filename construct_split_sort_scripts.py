...
session_swarm.write("swarm -g 10 -b 30 -t 2 --partition norm --gres=lscratch:15 --time 2:00:00 --merge-output --logdir " + session_dir + "/log_dump -f " + session_dir + "/sort_big_bash%s.sh" % refset)
session_swarm.close()
